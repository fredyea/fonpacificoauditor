...
const gerenciaItems = [
  { name: 'Dashboard', path: '/gerencia/dashboard' },
  { name: 'Indicadores', path: '/gerencia/dashboard/indicadores' },
  { name: 'Reportes', path: '/gerencia/dashboard/reportes' },
  { name: 'Proyectos', path: '/gerencia/dashboard/proyectos' },
  { name: 'Presupuestos', path: '/gerencia/dashboard/presupuestos' }
];

export default function GerenciaDashboardLayout({ children }) {
