...
const carteraItems = [
  { name: 'Clientes', path: '/cartera/dashboard/clientes' },
  { name: 'Créditos', path: '/cartera/dashboard/creditos' },
  { name: 'Cobranzas', path: '/cartera/dashboard/cobranzas' },
  { name: 'Reportes', path: '/cartera/dashboard/reportes' }
];

export default function CarteraDashboardLayout({ children }) {
