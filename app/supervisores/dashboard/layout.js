...
const supervisoresItems = [
  { name: 'Contratos Activos', path: '/supervisores/dashboard/contratos-activos' },
  { name: 'Contratos Suspendidos', path: '/supervisores/dashboard/contratos-suspendidos' },
  { name: 'Lista Supervisores', path: '/supervisores/dashboard/lista-supervisores' },
  { name: 'Asignaciones', path: '/supervisores/dashboard/asignaciones' }
];

export default function SupervisoresDashboardLayout({ children }) {
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <Link href="/supervisores/dashboard">
                    <Image
