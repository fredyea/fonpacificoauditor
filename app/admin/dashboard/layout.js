...
const adminItems = [
  ...
  { name: 'Usuarios', path: '/admin/dashboard/usuarios' },
  { name: 'Roles', path: '/admin/dashboard/roles' },
  { name: 'Permisos', path: '/admin/dashboard/permisos' },
  { name: 'Configuración', path: '/admin/dashboard/configuracion' },
          ...
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center">
              <div className="text-gray-400 text-sm">
                © 2025 Administración Sistema SIFP
              </div>
              <div className="text-gray-400 text-sm">
                Versión 1.0
              </div>
