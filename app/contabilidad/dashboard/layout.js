...
const contabilidadItems = [
  { name: 'Comprobantes', path: '/contabilidad/dashboard/comprobantes' },
  { name: 'Informes', path: '/contabilidad/dashboard/informes' },
  { name: 'Conciliación', path: '/contabilidad/dashboard/conciliacion' },
  { name: 'Balance', path: '/contabilidad/dashboard/balance' }
];

export default function ContabilidadDashboardLayout({ children }) {
