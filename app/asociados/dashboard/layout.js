...
const asociadosItems = [
  { name: 'Registro', path: '/asociados/dashboard/registro' },
  { name: 'Consultas', path: '/asociados/dashboard/consultas' },
  { name: 'Documentos', path: '/asociados/dashboard/documentos' },
  { name: 'Historial', path: '/asociados/dashboard/historial' }
];

export default function AsociadosDashboardLayout({ children }) {
