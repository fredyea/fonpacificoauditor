...
const tesoreriaItems = [
  { name: 'Vales', path: '/tesoreria/dashboard/vales' },
  { name: 'Egresos', path: '/tesoreria/dashboard/egresos' },
  { name: 'Facturas', path: '/tesoreria/dashboard/facturas' },
  { name: 'Recaudos', path: '/tesoreria/dashboard/recaudos' },
  { name: 'Legalizar', path: '/tesoreria/dashboard/legalizar' }
];

export default function TesoreriaDashboardLayout({ children }) {
