...
const fetchData = async () => {
  try {
    ...
    const responsepe = await fetch(_servidorapi+'egresosxcomprobantes');
    const jsonDatape = await responsepe.json();
    setEgresos(jsonDatape);
    const responsepv = await fetch(_servidorapi+'valesxcomprobantes');
    const jsonDatapv = await responsepv.json();
  } catch (error) {
